...
GITHUB_TOKEN = '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'  
...
def generate_pdf_report(vehicle_reg_number, title,  First_name, last_name, effective_datetime, expiry_datetime, policy_num):
    ...
    p.drawString(38, 445, "     of goods or passengers for hire and reward, or for any purpose inconnection with the motor trade.")
    p.setFont("Helvetica-Bold", 10)
    ...
    p.drawString(30, 370, "For and on behlf of underwriters subscribing to KGM Motor.")
    p.drawString(100, 320, "KFM Motor")
